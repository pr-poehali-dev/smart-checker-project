...
import { ArrowRight, Sparkles, Fish, Flame } from "lucide-react"
    ...
    <section className="relative min-h-[90vh] flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="container mx-auto text-center max-w-5xl relative z-10">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-6 animate-fade-in-up">
          ...
          <span className="text-sm font-medium text-primary">Живые и варёные раки — доставка по всему городу</span>
        </div>
        ...
        <p className="text-xl sm:text-2xl text-muted-foreground mb-10 max-w-3xl mx-auto animate-fade-in-up animate-delay-100 leading-relaxed">
          Свежие живые раки и вкуснейшие варёные — прямо к вашему столу. Только отборный продукт, быстрая доставка и честные цены.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in-up animate-delay-200 mb-12">
          ...
          <Button
            ...
            asChild
          >
            <a href="#portfolio">Наш ассортимент</a>
          </Button>
        </div>
        ...
        <div className="flex flex-wrap justify-center items-center gap-8 text-sm text-muted-foreground animate-fade-in-up animate-delay-300">
          <div className="flex items-center gap-2">
            ...
            <span>Живые раки</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-2 h-2 rounded-full bg-primary animate-pulse" style={{ animationDelay: "0.5s" }} />
            <span>Варёные раки</span>
          </div>
          <div className="flex items-center gap-2">
