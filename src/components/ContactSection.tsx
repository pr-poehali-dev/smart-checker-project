      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 text-balance">
            Оформите <span className="text-primary">заказ прямо сейчас</span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-pretty leading-relaxed">
            Оставьте заявку — и мы свяжемся с вами для подтверждения заказа. Доставим свежих раков в тот же день!
          </p>
        </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      onChange={handleChange}
                      placeholder="Вид раков (живые/варёные), размер, количество кг..."
                      rows={6}
                      required
                      className="transition-all focus:scale-[1.02]"
                    />
